...
<?php 
$str_rp_naics5_2016 = file_get_contents('http://localhost/json_data/csvjson_rp_naics5_2016.json');
$json_rp_naics5_2016 = json_decode($str_rp_naics5_2016, true);
?>
<table id="example_rp_naics5_2016" class="display" style="width:100%">
        <thead>
            <tr>
                <th>NAICS Code</th>
                <th>Country</th>
        ...
        <tbody>
            <?php foreach ($json_rp_naics5_2016 as $key => $value) {
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        console.log('working');
        $('#example_rp_naics5_2016').DataTable();
    } );
</script>
