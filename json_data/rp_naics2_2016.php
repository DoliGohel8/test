...
<?php 
$str_rp_naics5_2016 = file_get_contents('http://localhost/json_data/csvjson_rp_naics2_2016.json');
$json_rp_naics5_2016 = json_decode($str_rp_naics5_2016, true);
?>
<table id="example_rp_naics2_2016" class="display" style="width:100%">
        <thead>
            <tr>
                <th>NAICS Code</th>
                <th>Country</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example_rp_naics2_2016').DataTable();
    } );
</script>